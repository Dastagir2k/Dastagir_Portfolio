const Contact = () => {
  return (
    <section id="contact" className="w-full h-screen bg-gradient-to-b  from-gray-800 to-black  p-4 text-white">
      <div className="flex flex-col justify-center p-4 max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center items-center">
          <form action="https://getform.io/f/mepEkQaM" method="POST" className="flex flex-col w-full md:w-1/2">
            <input
              type="text"
              name="name"
            ...
            rounded-md hover:sacle-110 duration-300">Lets Talk</button>
          </form>
        </div>
      </div>
    </section>
